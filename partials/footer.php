<footer>
    <div class="width">
        ...
        <p class="copyright"><a href="<?php echo $url; ?>"><?php echo $title_name; ?></a> - <a href="https://mycoding.id" rel="dofollow" target="_blank">2022</a> - <a href="https://401xd.com" rel="dofollow" target="_blank">Sngu</a></p>
    </div>
</footer>